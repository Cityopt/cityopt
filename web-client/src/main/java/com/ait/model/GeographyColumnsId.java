...
public class GeographyColumnsId implements java.io.Serializable {
	...
	public GeographyColumnsId(String FTableCatalog, String FTableSchema,
			String FTableName, String FGeographyColumn, Integer coordDimension,
	...
	public boolean equals(Object other) {
		...
		return ((this.getFTableCatalog() == castOther.getFTableCatalog()) || (this
				...
				&& ((this.getFGeographyColumn() == castOther
						.getFGeographyColumn()) || (this.getFGeographyColumn() != null
						&& castOther.getFGeographyColumn() != null && this
						.getFGeographyColumn().equals(
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFGeographyColumn() == null ? 0 : this
						.getFGeographyColumn().hashCode());
		result = 37
				* result
