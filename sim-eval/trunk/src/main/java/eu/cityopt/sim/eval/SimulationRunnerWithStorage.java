...
public class SimulationRunnerWithStorage implements SimulationRunner {
	...
	public SimulationRunnerWithStorage(SimulationRunner runner, SimulationStorage storage) {
		this.runner = runner;
	...
	public Future<SimulationOutput> start(SimulationInput input) {
		...
		if (output != null) {
			...
			return new FutureTransform<SimulationOutput, SimulationOutput>(simulation) {
