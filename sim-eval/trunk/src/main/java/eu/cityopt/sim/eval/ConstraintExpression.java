...
public class ConstraintExpression extends DoubleExpression {
	...
	public ConstraintExpression(int constraintId, String source,
		...
		if (lowerBound > upperBound) {
			throw new EvaluationException("Lower bound " + lowerBound + " exceeds upper bound "
					+ upperBound + " of constraint " + source);
		}
	}
	...
	/**
	 * Computes the infeasibility of the constraint, i.e. by how much it is violated.
	 * 0.0 means that the constraint is satisfied, positive values that it is unsatisfied.
	 */
	@Override
