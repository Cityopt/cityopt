...
<title>CityOpt create multi scenario</title>
<link rel="stylesheet" type="text/css" href="assets/css/style.css" />
</head>
<body>
<%@ include file="mainmenu.inc"%>

<form:form method="post" action="createmultiscenario.html" modelAttribute="multiscenario">
<table>
	<tr>
		<td width=20></td>
		<td>
				...
				<tr valign="top">
					<td valign="top">
						<table>
							<tr>
								<td>Name:</td>
								<c:set var="tooltip_name">Multi scenario name</c:set>
				 ...
				 <c:choose>
          			  <c:when test="${success!=null && success==true}">
            			   <h2 class="successful">Multi scenario created</h2>
            		...
            		<c:when test="${success!=null && success==false}">
            			   <h2 class="error">Multi scenario already exists</h2>
            		</c:when>            	
        		</c:choose>						
