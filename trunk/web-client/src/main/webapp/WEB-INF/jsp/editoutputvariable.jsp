			...
			<table class="maintable">			
				...
				<tr class="titlerow">
					...
					<td>
						<table width="100%">
							<tr>
								<td><font class="activeproject">${project.name}</font>&nbsp;&nbsp;<spring:message code="edit_output_variable_small"/></td>
					...
					<td valign="top">
						...
						<table>
							...
							<tr>
								<td></td>
								<td align="right">
									<button class="activebutton" style="width:100px" type="submit"><spring:message code="update"/></button>								<input style="width:100px" type="submit" name="cancel" value="<spring:message code="cancel"/>">
								</td>
							</tr>
						</table>
						</form:form>
